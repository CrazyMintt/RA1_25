...
class TestAnalisadorLexico(unittest.TestCase):
    ...
    def test_valida_expressao_simples(self):
        ...
        self.assertEqual(tokens[0].tipo, TipoToken.NUMERO_INTEIRO)
        self.assertEqual(tokens[1].tipo, TipoToken.NUMERO_INTEIRO)
        self.assertEqual(tokens[2].tipo, TipoToken.OPERADOR)
    ...
    def test_valida_expressao_com_real_e_memoria(self):
        ...
        self.assertEqual(tokens[0].tipo, TipoToken.NUMERO_REAL)
        self.assertEqual(tokens[1].tipo, TipoToken.KEYWORD)
        self.assertEqual(tokens[2].tipo, TipoToken.OPERADOR)
